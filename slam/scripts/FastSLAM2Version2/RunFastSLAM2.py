...
def runFastSlam2(pkl = '../datasets/Jar/dataset1.pkl'):
  ...
  robot = Alfie2D(random, initial_pose, default_pose_cov)
  algorithm = FastSLAM2(robot, parameters = params, random = random)
  ...
  for i in range(NUM_STEPS):
    ...
    if i==0:
      algorithm.prev_t = t
      algorithm._robot.initial_pose[2] = wrapToPi(robotData.getCompass(t))
