...
class RobotBase():
    ...
    def loadData(pkl =  '../datasets/Jar/dataset1.pkl'):
        global algorithm
        dataloader = pickle.load(open(pkl,'rb'))
        self.robotData = dataloader.robots[ROBOT_ID]
        if INIT_LANDMARKS:
    ...
    def runFastSlam2(self):
        ...
        for i in range(NUM_STEPS):
            ...
            if i==0:
                ...
                self.algorithm._robotPhysics.initial_pose[2] = wrapToPi(robotData.getCompass(t))
