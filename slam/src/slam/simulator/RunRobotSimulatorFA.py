import copy
import numpy as np
from slam.robot_physics.RobotSimulatorPhysicsFA import RobotPhysics2DFAForSim
...
if __name__ == '__main__':
  ...
  robot_physics = RobotPhysics2DFAForSim(random, close_enough_position_for_motion, verbose = True)
  ...
  runner = RobotSimulatorRunner(robot_physics, random, num_steps, hardcode_compass, hardcode_pose, 
                  ...
                  fast_slam_version = 2, plot_msg = 'Fast SLAM 2 with fully actuated physics')
  runner.run()
