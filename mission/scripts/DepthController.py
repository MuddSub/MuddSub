...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        if depth_controller.start == False:
            depth_controller.publish_pwm(depth_controller.default_pwm)
