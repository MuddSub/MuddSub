...
from vision.MSCV2.netdev import read_cfg # import function to read config file
from vision.MSCV2.network.network_blocks import NET_BLOCKS, DetBlock # import network blocks
