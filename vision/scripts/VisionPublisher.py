...
class VisionPublisher:
    def __init__(self):
        self.camera_info_pub = rospy.Publisher('camera/info', CameraInfo, queue_size=10)
        self.raw_image_pub = rospy.Publisher('camera/image/raw', Image, queue_size=10)
        self.greyscale_image_pub = rospy.Publisher('camera/image/raw', Image, queue_size=10)
        self.compressed_image_pub = rospy.Publisher('camera/image/compressed', CompressedImage, queue_size=10)
        self.bboxes_pub = rospy.Publisher('camera/bounding_boxes', BoundingBox2DArray, queue_size=10)
        self.detection_pub = rospy.Publisher('vision/detection', Detection, queue_size=10)
