...
class Navigate(smach.State):
  def __init__(self):
    smach.State.__init__(self, goal, measurement, motion_style, timeout,
  ...
  def execute(self, userdata):
    ...
    if not self.initialized:
      ...
      elif time-self.startTime <= userdata.timeout and action_status in [ACTIVE, LOST]:
