...
if __name__ == '__main__':
		...
		hfl_subscriber = rospy.Subscriber('/robot/pwm/hfl', Int32, pulseToSerial, (7), queue_size=1)
		hfr_subscriber = rospy.Subscriber('/robot/pwm/hfr', Int32, pulseToSerial, (2), queue_size=1)
		hbl_subscriber = rospy.Subscriber('/robot/pwm/hbl', Int32, pulseToSerial, (6), queue_size=1)
		hbr_subscriber = rospy.Subscriber('/robot/pwm/hbr', Int32, pulseToSerial, (3), queue_size=1)

		vfl_subscriber = rospy.Subscriber('/robot/pwm/vfl', Int32, pulseToSerial, (5), queue_size=1)
		vfr_subscriber = rospy.Subscriber('/robot/pwm/vfr', Int32, pulseToSerial, (0), queue_size=1)
		vbl_subscriber = rospy.Subscriber('/robot/pwm/vbl', Int32, pulseToSerial, (4), queue_size=1)
